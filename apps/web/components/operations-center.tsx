...
import { MailIcon, SendIcon, Settings2Icon, TicketIcon } from "lucide-react"
...
import {
  apiRequest, userFacingErrorMessage,
...
export function OperationsCenter({ refreshVersion = 0 }: { refreshVersion?: number }) {
  ...
  async function createInvitation() {
    ...
    try {
      ...
      setPassword(""); toast.add({ title: "邀请已创建", description: invitation.url, type: "success" }); await load()
